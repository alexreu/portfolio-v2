    ...
    return (
        <>
            ...
            <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden px-4 py-8">
                ...
                >
                    <div
                        className="border-border relative overflow-hidden rounded-3xl border bg-[#0A090D] p-8 shadow-2xl md:p-12"
                        style={{
                            boxShadow:
                                "0 20px 60px rgba(0, 0, 0, 0.5), 0 0 40px rgba(255, 45, 85, 0.05)",
                        }}
                    >
                        <motion.div
                        ...
                        >
                            <motion.h1
                                className="to-primary relative inline-block bg-linear-to-r from-[#FF2D55] bg-clip-text text-8xl font-bold text-transparent md:text-9xl"
                                style={{
                                    textShadow:
                                ...
                                animate={{
                                    textShadow: [
                                        "0 0 60px rgba(255, 45, 85, 0.5), 0 0 100px rgba(255, 45, 85, 0.2)",
                                        "0 0 80px rgba(255, 45, 85, 0.6), 0 0 120px rgba(255, 45, 85, 0.3)",
                                        "0 0 60px rgba(255, 45, 85, 0.5), 0 0 100px rgba(255, 45, 85, 0.2)",
                                    ],
                                }}
                                transition={{
                        ...
                        >
                            <Link href="/" className="flex">
                                <motion.span
                                    className="group bg-primary focus:ring-primary relative w-full overflow-hidden rounded-xl px-8 py-4 font-medium text-white transition-all duration-300 hover:shadow-[0_0_30px_rgba(255,45,85,0.5)] focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#141418] focus:outline-none sm:w-auto"
                                ...
                                >
                                    ...
                                    <motion.div
                                        className="to-primary absolute inset-0 bg-linear-to-r from-[#FF2D55]"
                                        initial={{ opacity: 0 }}
