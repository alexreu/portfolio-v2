...
export const EducationCard = ({ data }: Props) => {
    return (
        <Card className="relative col-span-1 flex flex-col justify-center opacity-100 backdrop-blur-xl lg:order-last lg:col-span-3 xl:order-0 xl:col-span-6">
            <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            >
                ...
                <CardContent>
                    <ul className="grid grid-cols-2 gap-y-6">
                        {data.map(
                            ({ _key, yearOfGraduation, graduationTitle, trainingLocation }) => (
