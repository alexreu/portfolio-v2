        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-12">
            <div className="col-span-1 flex flex-col gap-5 xl:col-span-4">
                <div className="flex flex-col gap-5">
                    <h1 className="text-primary font-semibold">Contact info</h1>
                    <h2 className="text-4xl font-semibold text-white">Get in touch</h2>
                    <p className="text-muted-foreground font-semibold">Don&apos;t be afraid !</p>
                </div>
                <ul className="flex flex-wrap justify-between gap-8 md:justify-start lg:flex-col lg:flex-nowrap">
                    <li className="group inline-flex items-center gap-5">
                        <div className="group-hover:border-primary flex h-20 w-20 items-center justify-center rounded-full border-2 border-white transition-all duration-300 ease-in-out">
                    ...
                    <li className="group inline-flex items-center gap-5">
                        ...
                        <div className="flex flex-col gap-2 text-white">
                            ...
                            <Link
                                ...
                                className="hover:text-primary inline-flex items-center gap-1 rounded-lg transition-all duration-300 ease-in-out"
                            >
