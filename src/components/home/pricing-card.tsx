    ...
    <GlassCard className="p-4 sm:p-8 md:p-10" hoverScale={false}>
        <section aria-labelledby="pricing-heading" className="space-y-8">
            <div className="space-y-3 text-center">
                ...
                <p className="text-gray-300">Investissez dans un site qui travaille pour vous.</p>
            </div>
            ...
            <div className="grid items-stretch gap-4 xl:grid-cols-3">
                {plans.map((plan) => {
                    ...
                    return (
                        <article
                            key={plan._id}
                            className={`flex min-w-0 flex-col rounded-2xl border bg-white/3 p-5 sm:p-6 ${plan.isPopular ? "border-primary/40" : "border-white/10"}`}
                        >
                            ...
                            {!!details?.length && (
                                <details className="mt-3 text-sm text-gray-300">
                                    <summary className="focus-visible:outline-primary cursor-pointer rounded py-2 focus-visible:outline-2 focus-visible:outline-offset-4">
                                        Détails de l’offre{" "}
                            ...
                            <div className="mt-auto pt-4">
                                <Button
                                    ...
                                    asChild
                                >
                                    <a href="#contact">{plan.ctaText || "Parler de mon projet"}</a>
                                </Button>
                            </div>
                        </article>
                    );
